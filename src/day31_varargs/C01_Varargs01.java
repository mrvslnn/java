...
public class C01_Varargs01 {
	...
	public static void main(String[] args) {
		// verilen iki sayýnýn toplamýný bulan metod yazýn
		//verilen üç sayýnýn toplamýný bulan metod yazýn
	...
	private static void ucSayiTopla(int sayi1, int sayi2, int sayi3) {
		System.out.println("üç sayý toplamý : "+(sayi1+sayi2+sayi3));
		
	}

	private static void ikiSayiTopla(int sayi1, int sayi2) {
		System.out.println("iki sayý toplamý : "+(sayi1+sayi2));
